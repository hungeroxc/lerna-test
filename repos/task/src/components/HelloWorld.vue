  ...
  <div class="hello">
    <div class="draft-list-wrapper">
      <el-table :data="draftList" border height="500" style="width: 100%">
        ...
        <el-table-column prop="billNum" label="票据号"></el-table-column>
    ...
    <div class="order-list-wrapper">
      <el-table :data="orderList" border height="500" style="width: 100%">
        ...
        <el-table-column prop="billId" label="票据id"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    orderTheBill(index) {
      ...
      this.orderList.unshift(Draft.orderTheBill(targetDraft));
    },
